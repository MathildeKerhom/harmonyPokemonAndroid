...
public class PokemonProviderBase extends ContentProvider {
    ...
    public void loadAdapters() {
        ...
        NpcProviderAdapter npcProviderAdapter = new NpcProviderAdapter(this);
        this.db = npcProviderAdapter.getDb();
        this.providerAdapters.add(npcProviderAdapter);
        this.providerAdapters.add(new TypesProviderAdapter(this));
        this.providerAdapters.add(new DresseursProviderAdapter(this));
        this.providerAdapters.add(new NpctoBadgesProviderAdapter(this));
