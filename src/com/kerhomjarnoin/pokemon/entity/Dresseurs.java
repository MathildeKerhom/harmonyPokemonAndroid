...
public class Dresseurs  implements Serializable , Parcelable {
     ...
     */
    public void setNpc(final Npc value) {
         this.npc = value;
    }
    /**
    ...
    public void writeToParcelRegen(Parcel dest, int flags) {
        ...
        if (this.getNpc() != null
                    && !this.parcelableParents.contains(this.getNpc())) {
            this.getNpc().writeToParcel(this.parcelableParents, dest, flags);
        } else {
    ...
    public void readFromParcel(Parcel parc) {
        ...
        this.setNpc((Npc) parc.readParcelable(Npc.class.getClassLoader()));
    }
