...
@Entity
@Rest
public class TypeObjet  implements Serializable , Parcelable {
     ...
     * Parcelable creator.
     */
    public static final Parcelable.Creator<TypeObjet> CREATOR
        = new Parcelable.Creator<TypeObjet>() {
        public TypeObjet createFromParcel(Parcel in) {
            return new TypeObjet(in);
        }
        
        public TypeObjet[] newArray(int size) {
            return new TypeObjet[size];
        }
    };
